...
public class Lab9a {
	...
	public static void main(String[] args) {
	    ...
	    String choice = "Banana";												//Holds user input of type String
	...
	public static int deleteItems(Scanner sIn, ArrayList<String> shoppingList) {
		...
		while(true){
			...
			String item = sIn.nextLine();
			if(!item.isEmpty()){
				Boolean isRemoved = shoppingList.remove(item);
				if(isRemoved){
					cont ++;
					System.out.println(item+" has been deleted to the Shopping List.");
				}else{
